...
func TestRegistryCoversEveryKnownFieldByName(t *testing.T) {
	want := []string{
		...
		"project.Techdebt.Exclude",
		"cmd.previewReport.OutOfTree",
		"cmd.previewReport.Unmatched",
		"cmd.previewLaneReport.Dropped",
		"cmd.previewLaneReport.Selector",
		"cmd.statsSummary.Path",
		"changes.Landmark.Loc",
		"verify.SkippedFile.File",
		"verify.LegSummary.WholeFile",
		"verify.LegSummary.Ranges",
		"verify.OutOfScopeMutant.File",
		...
		"mutation.strykerNetRoot.ProjectRoot",
		"stack.Signals.Files",
