...
- `collectInbound` (mark-free inbound filter, shared with the watch heartbeat) — `internal/cmd/issue.go:1052`

_introduced board-sync-truth · a587471_
